...
<body>
    ...
    <div class="column">
        ...
        <ul>
            <li>[Comparing TDA Methods of Time Series Analysis](DQE_Final_Draft.pdf)</li>
            <li>[Predictive Models for Perceptions of Police-Community Interactions Involving Use of Force](Perceptions_of_Force_Update_March_2024.pdf)</li>
            <li>[Factors That Impact Uses of Force in Police-Community Interactions](Mapper_Analysis.pdf)</li>
        </ul>
    </div>
